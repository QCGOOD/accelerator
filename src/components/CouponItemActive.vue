<template>
  <div class="coupon-item white" v-if="item.avaliable" @click="onClick" :class="[type === 'guoqi' ? '' : index % 2 === 0 ? 'red' : 'blue']">
    <div class="left">
      <button class="shiyong" v-if="type === 'keyong'">使用></button>
      <p class="title">{{item.title}}</p>
      <span class="english">{{item.description}}</span>
      <div class="bottom">
